...
export class AverageTablePage implements OnInit {
  ...
  constructor(public loadingController: LoadingController, private menuCtrl: MenuController, private auth: AuthService, private centroService: CentrosService, private healthExtendService: HealthsExtendService) { }
